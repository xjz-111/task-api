 ...
 * 时间：2021-07-02 01:15
 */
@Task(priority = 1, thread = TaskType.CHILD_THREAD)
public class TaskThread1 implements InitTask {
    @Override
    ...
    public InitTaskCallback callback() {
        return new InitTaskCallback() {
            ...
            public void onSuccess() {
                Log.i("xjzhao", TaskThread1.class.getSimpleName() + " init onSuccess!");
            }

            @Override
            public void onSuccessInThread() {
                Log.e("xjzhao", TaskThread1.class.getSimpleName() + " init onSuccessInThread!");

            }

            @Override
            public void onFailure(Exception e) {
                Log.e("xjzhao", TaskThread1.class.getSimpleName() + " init onFailure!");

            }

            @Override
            public void onFailureInThread(Exception e) {
                Log.v("xjzhao", TaskThread1.class.getSimpleName() + " init onFailureInThread!");
