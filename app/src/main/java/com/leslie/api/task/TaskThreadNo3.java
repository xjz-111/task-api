 ...
 */
@Task
public class TaskThreadNo3 implements InitTask {
    @Override
    ...
    public InitTaskCallback callback() {
        return new InitTaskCallback() {
            ...
            public void onSuccess() {
                Log.i("xjzhao", TaskThreadNo3.class.getSimpleName() + " init onSuccess!");
            }

            @Override
            public void onSuccessInThread() {
                Log.e("xjzhao", TaskThreadNo3.class.getSimpleName() + " init onSuccessInThread!");

            }

            @Override
            public void onFailure(Exception e) {
                Log.e("xjzhao", TaskThreadNo3.class.getSimpleName() + " init onFailure!");

            }

            @Override
            public void onFailureInThread(Exception e) {
                Log.v("xjzhao", TaskThreadNo3.class.getSimpleName() + " init onFailureInThread!");
