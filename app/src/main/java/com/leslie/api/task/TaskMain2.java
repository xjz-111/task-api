 ...
 * 时间：2021-06-29 12:48
 */
@Task(priority = 2, thread = TaskType.MAIN_THREAD)
public class TaskMain2  implements InitTask {
    @Override
    ...
    public InitTaskCallback callback() {
        return new InitTaskCallback() {
            ...
            public void onSuccess() {
                Log.i("xjzhao", TaskMain2.class.getSimpleName() + " init onSuccess!");
            }

            @Override
            public void onSuccessInThread() {
                Log.e("xjzhao", TaskMain2.class.getSimpleName() + " init onSuccessInThread!");

            }

            @Override
            public void onFailure(Exception e) {
                Log.e("xjzhao", TaskMain2.class.getSimpleName() + " init onFailure!");

            }

            @Override
            public void onFailureInThread(Exception e) {
                Log.v("xjzhao", TaskMain2.class.getSimpleName() + " init onFailureInThread!");
