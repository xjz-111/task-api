 ...
 * 时间：2021-07-02 01:17
 */
@Task(priority = 3, thread = TaskType.CHILD_THREAD)
public class TaskThread3 implements InitTask {
    @Override
    ...
    public InitTaskCallback callback() {
        return new InitTaskCallback() {
            ...
            public void onSuccess() {
                Log.i("xjzhao", TaskThread3.class.getSimpleName() + " init onSuccess!");
            }

            @Override
            public void onSuccessInThread() {
                Log.e("xjzhao", TaskThread3.class.getSimpleName() + " init onSuccessInThread!");

            }

            @Override
            public void onFailure(Exception e) {
                Log.e("xjzhao", TaskThread3.class.getSimpleName() + " init onFailure!");

            }

            @Override
            public void onFailureInThread(Exception e) {
                Log.v("xjzhao", TaskThread3.class.getSimpleName() + " init onFailureInThread!");
